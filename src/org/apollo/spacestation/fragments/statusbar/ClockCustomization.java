...
public class ClockCustomization extends SettingsPreferenceFragment implements
        Preference.OnPreferenceChangeListener {

    private static final String TAG = "ClockCustomization";
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.status_bar_clock_customization);
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.status_bar_clock_customization);
}
