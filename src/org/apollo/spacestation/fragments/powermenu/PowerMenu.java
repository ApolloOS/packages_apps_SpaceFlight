...
package org.apollo.spacestation.fragments.powermenu;
...
public class PowerMenu extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.spacestation_power_menu);
        ...
        if (!ApolloUtils.deviceHasFlashlight(getActivity())) {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.spacestation_power_menu);
}
